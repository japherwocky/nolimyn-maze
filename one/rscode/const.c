...
/*
	Something like:
{
	"spell name", { level you can learn spell by class },
	spell_function, 	TARGET_BIT,		POSITION_BIT,
	&gsn_affect,	0|CANCEL_BIT|DISPEL_BIT, int, int, 						// uhh.. dunno
	"damage verb",	"Fade Pecho", "$n's room fade echo", CMD_BIT
}
	 

// spell_function is also declared with DECLARE_SPELL_FUN(   spell_null     ); in headers?
*/
...

{
	...
	"faerie fog",		"The purple goo on your body fades away.", "The purple fog on $n fades away.", CMD_BOTH
    },
	...
	"radiant light",	"Your vision slowly begins to return.","$n looks around, able to see once again.", CMD_COMMUNE
    },
	...
	"",			"You slowly sink to the ground.",	"$n slowly sinks to the ground.", CMD_BOTH
    },
	...
	"$n shimmers into view.", CMD_SPELL
    },
	...
	"",			"You are no longer invisible.",		"$n shimmers into view.", CMD_BOTH
    },
	...
	NULL,			CAN_DISPEL|CAN_CANCEL,	20,	12,
	"",			"You feel solid again.",	"$n looks more solid.", CMD_BOTH
    },
...
/* add race/class specific skills here .. TODO: break out this huge block?
	there must be another table that has skill/spells per class .. unless it's from
	the values above?! yikes
	also todo perhaps, use this for cabal skills
*/
