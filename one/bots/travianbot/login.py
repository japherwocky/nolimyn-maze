...
url = urljoin(conf.baseurl,'dorf1.php')
...
"""
vars = {'w':'800:600', #or whatever, we could set this in conf
...
def login(url=url,vars=vars,headers=headers):
   req = urllib2.Request(url, urllib.urlencode(vars))
