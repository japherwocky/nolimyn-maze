...
// ok.. coinage for the sacrifice..  obj->level ?  I hope.
    ch->gold += obj->level*61;
// I'm not sure.. how the act() function works.  TODO, echo the coins.
    act("The gods reward your sacrifice of $p with some coins.",ch,obj,NULL,TO_CHAR);
...
void do_recite( CHAR_DATA *ch, char *argument )
{
	...
	*/
    ...
    if (number_percent() >= 35 + get_skill(ch,gsn_scrolls) * 4/5 + UMAX(0, alangbonus * 3))
    {
