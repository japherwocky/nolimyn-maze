...
//is this for real?  this whole section gives off a deadweight vibe.
...
// this RIFTINCLD seems like deadweight?
#ifndef RIFTINCLD
//#include "rift.h"
#include "mud.h"
#define RIFTINCLD
...
struct pc_race_type  /* additional data for pc races */
{
	...
	sh_int	racePulse;		/* combat pulse for this race */ // no way?!
 ...
 * Actually.. it seems many of these no longer even exist.
...
//NOCTURNAL & DIURNAL seem to be buggy- i'm trying to ninja them out
/*
#define ACT_NOCTURNAL			(ff)
#define ACT_DIURNAL			(gg)
*/

// so - these were hh & ii; looks like they should be ff gg
#define ACT_FASTWANDER			(ff)
#define ACT_LAW					(gg)
...
#define ITEM_WEAR_FLOAT		(P) // is this a real slot?
