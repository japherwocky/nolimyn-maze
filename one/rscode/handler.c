...
/*
 * The code isn't checking for player's lights (as far as I can tell?
 * (what does the pRoomIndex->light > 2 check for?)
 * so that newbie mobs, etc, are impossible to see.
 * for now, let's try always returning FALSE
