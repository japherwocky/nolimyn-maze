...
const struct cabal_type cabal_table[MAX_CABAL] =
    {
//  name,   who entry,	extitle, cabal name, 	independent, 	item vnum, 	limit (pfiles / limit), start level
        /* independent should be FALSE if is a real cabal */
{"none",    "",     		"",		"",				TRUE,		1,		1, 		1},
{"guild",   "[GUILD] ", "",   	"Common Guild, Protectors of Shalar",FALSE,  	0,		1, 		1},
{"scion",    "[SCION] ", "",   	"Scion of Knowledge",		FALSE,  	23652,		30, 		1},
...
// used with affto, and OLC, but not much else.. maybe for npcs
...
const struct bounty_type bounty_table[MAX_BOUNTY] =
    {
        ...
        {   "hunter", 	"Bounty Hunter", 			10		},
        {   "veteran",	"Veteran Hunter",			30		},
        {    "elder",	"Elder Hunter",			50		},
        {    "master",	"Master Hunter",			100	},
    };
...
const struct cabal_list cabal_skills[] =
    {
        ...
        { CABAL_BOUNTY, "hire mercenary",		2, FALSE},
        { CABAL_BOUNTY, "hunters vision",		4,	FALSE},
        { CABAL_BOUNTY, "hunters stealth",	4, FALSE}, // er.. doesn't exist. :(
