...
class OpenIdMixin(object):
    ...
    def _on_authentication_verified(self, callback, response):
        ...
        #add in the actual uniqid, hashed for giggles (dunno if that URL is private or what)
        user['id'] = md5.new( self.request.arguments['openid.identity'][-1] + 'saltysalt').hexdigest() #TODO: better salt ;)
