...
void do_outfit ( CHAR_DATA *ch, char *argument )
{
	...
	if(ch->level > 125 && !IS_IMMORTAL(ch))
...
// these slots don't get geared -
// to fix, change get_obj_index(bodypart)

// how the hell does create_object work?.. 
...
*/
	...
	//we need some coinage in here, baby!  a sack?!

	//load treasure with.. obj_to_obj( obj, container ),
	//but how do we load gold?
